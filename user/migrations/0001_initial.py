...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('shelf_id', models.CharField(max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveIntegerField(choices=[(0, 'no rating'), (1, 'did not like it'), (2, 'it was ok'), (3, 'liked it'), (4, 'really liked it'), (5, 'it was amazing')], default=3)),
